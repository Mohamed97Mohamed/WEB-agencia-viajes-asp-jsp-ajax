...
<%
	...
	SentenciaSQL = "select IDVUELO,CIUDAD_ORIGEN,CIUDAD_DESTINO,FECHA,COMPANIA,N_PLAZAS_DISPONIBLES,DURACION,PRECIO from LISTA_VUELOS_PRECIO where CIUDAD_ORIGEN='" & origen &"' and CIUDAD_DESTINO='"& destino&"'" 
