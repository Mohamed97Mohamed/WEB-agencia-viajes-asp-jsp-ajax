...
<%
	...
	'Set consulta1 = Conexion.Execute("select CIUDAD from CIUDAD where IDCIUDAD="&destino)
	'ciudad=consulta1("CIUDAD")
	SentenciaSQL = "select IDVUELO,CIUDAD_ORIGEN,CIUDAD_DESTINO,FECHA,COMPANIA,N_PLAZAS_DISPONIBLES,DURACION,PRECIO from LISTA_VUELOS_PRECIO where CIUDAD_DESTINO='" & destino &"'" 
